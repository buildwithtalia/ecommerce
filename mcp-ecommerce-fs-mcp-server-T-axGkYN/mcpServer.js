...
if (result.error) {
  ...
  console.error("[Warning] Error:", result.error.message);
} else {
  console.error("[Info] Loaded .env file from:", envPath);
  console.error("[Info] BASE_URL:", process.env.BASE_URL || "(not set)");
}
